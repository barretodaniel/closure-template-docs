---
path: "/docs/developer-guide/basic-template"
---
...
`string`. (See the reference section on [types](../reference/types) for
...
be called from their host languages (see how to call from [JavaScript](rendering-a-template-in-js)) or from other Soy templates.
