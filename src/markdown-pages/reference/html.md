---
path: "/docs/reference/html-validation"
---
...
3.  Start tags for non-void elements can _not_ be self-closing. `<div/>` is
    invalid HTML.
...
According to the HTML spec, some tags [can be omitted](https://www.w3.org/TR/html5/syntax.html#optional-tags).
In particular, if certain criteria are met, the HTML parser can imply the start tags and/or end tags.
...
in some contexts. MathML is _not_ supported since it is deprecated and has
